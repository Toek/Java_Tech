...
五月的仓颉 [ITPUB技术小栈](javascript:void(0);) *2017-04-29*
...
|原文链接：www.cnblogs.com/xrq730/p/5060921.html
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/WKtM9X8hT24D3Wf2RqVItcQVQjjia9hs49ZpxQCbSxEryLhv9EXBUKwcvTMN2cbPVVvuXTc2AMibY7O8FCrPO2ag/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
**15、**wait()方法和notify()/notifyAll()方法在放弃对象监视器时有什么区别wait()方法和notify()/notifyAll()方法在放弃对象监视器的时候的区别在于：wait()方法立即释放对象监视器，notify()/notifyAll()方法则会等待线程剩余代码执行完毕才会放弃对象监视器。
